...
urlpatterns = [
    re_path(r'^catalog/reservations/$', views.reservation_list, name='reservation_list'),
    re_path(r'^catalog/reservations/<int:reservation_id>/confirm/$', views.confirm_reservation, name='confirm_reservation'),
    re_path(r'^catalog/reservations/<int:reservation_id>/reject/$', views.reject_reservation, name='reject_reservation'),
